...
def create_manager_test_suite():
    ...
    try:
        from tests.test_manager_expanded import TestManagerExpanded, TestManagerIntegration
        from tests.test_manager_edge_cases import TestManagerEdgeCases
        from tests.test_manager_performance import TestManagerPerformance, TestManagerStress
    except ImportError:
        # Fallback for direct execution
        from test_manager_expanded import TestManagerExpanded, TestManagerIntegration
        from test_manager_edge_cases import TestManagerEdgeCases
        from test_manager_performance import TestManagerPerformance, TestManagerStress
...
class TestManagerTestSuite(unittest.TestCase):
    ...
    def test_manager_test_categories(self):
        ...
        self.assertGreaterEqual(total_tests, 3, "Should have at least 3 test categories")
