...
class TestManagerExpanded(unittest.TestCase):
    ...
    def test_run_with_existing_manpage(self, mock_manpage_class):
        ...
        with patch(
            ...
            mgr = manager.manager(
                "localhost", "testdb", ["test.1.gz"], overwrite=False
            )
            added, exists = mgr.run()
    ...
    def test_edit_method_with_paragraphs(self):
        ...
        with patch(
            ...
            mock_fixer_instance.disable.assert_called_once_with(
                "paragraphjoiner"
            )
    ...
    def test_main_with_drop_confirmed(self, mock_input):
        ...
        with patch(
            "explainshell.manager.manager"
        ) as mock_manager_class, patch(
            "explainshell.manager.glob.glob"
        ) as mock_glob:
    ...
    def test_main_with_directory_path(self, mock_glob, mock_isdir):
        ...
        with patch("explainshell.manager.manager") as mock_manager_class:
            ...
            manager.main(
                ["/test/dir"], "testdb", "localhost", False, False, False
            )
    ...
    def test_process_method_flow(self):
        ...
        with patch(
            ...
            "explainshell.manager.options.extract"
        ) as mock_extract:
