...
REDIRECTION = textwrap.dedent(
    """       Before a command is executed, its input and output may be <u>redirected</u> using a special notation interpreted
...
_subshell = textwrap.dedent(
    """       (<u>list</u>) <u>list</u> is executed in a subshell environment (see <b>COMMAND</b> <b>EXECUTION</b>  <b>ENVIRONMENT</b>  below).   Variable
